...
# Develovers » Zaa-Store
# Email      » HurufKapital58@gmail.com
# telegram   » https://t.me/Zaa-Store
...
cd /usr/bin
wget https://raw.githubusercontent.com/Zaa-Store/Tunneling/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/Zaa-Store/Tunneling/main/bot/kyt.zip
unzip kyt.zip
